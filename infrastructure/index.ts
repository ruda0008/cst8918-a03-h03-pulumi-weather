...
const redisConnectionString = pulumi.interpolate`redis://:${redisAccessKey}@${redis.hostName}:${redis.port}`
    ...
    containers: [
      {
        ...
        environmentVariables: [
          ...
          },
          {
           ...
           {
            name: 'REDIS_URL',
            value: redisConnectionString, // Pass the Redis connection string to the app
          },
        ],
        resources: {
          requests: {
